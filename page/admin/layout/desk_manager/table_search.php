...
<div class="Category__right-item" id="table" data="1">
    ...
    <form method="POST" class="form2">
        <div class="dflexCenter margin-bottom-20 mobile-app">
            <div class="form-left">
                <span>Cơ sở</span>
                        ...
                        if ($TinhTrang == '0') {
                            ...
                            echo '
                                <tr>
                                    ...
                                    <th class="mobile__item">Số người lớn</th>
                                ...
                                if ($result[$i]['TinhTrang'] == 0) {
                                    ...
                                    echo '
                                        <tr>
                                            ...
                                            <td>' . $result[$i]['DiaChi'] . '</td>
                                            <td>' . $result[$i]['Ngay'] . '</td>
                                            <td class="mobile__item">' . $result[$i]['Gio'] . '</td>
                                            <td class="mobile__item">' . $result[$i]['num_adult'] . '</td>
                                            <td class="mobile__item">' . $result[$i]['num_child'] . '</td>
                                            <td>
